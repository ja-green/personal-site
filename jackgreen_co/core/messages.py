...
class Messages(object):
    ...
    core_footer_license_content = "The content on this website is licensed under the"
    core_e500_heading = "500"
    core_e404_heading = "404"
    core_e405_heading = "405"
    core_e400_heading = "400"
    core_e500_subheading = "An unexpected error has occurred on the server. Please try again later."
    core_e404_subheading = "The page you were looking for was not found."
    core_e405_subheading = "Your request method was not allowed."
    core_e400_subheading = "Your request contains bad syntax and cannot be fulfilled."
    core_error_action = "Go back to home"
